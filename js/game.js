...
const SPIRITS = {
  ...
  baam: {
    ...
    kolye: '06_GRAFIK/kolye_muhur_resmi.png',
    tile: '06_GRAFIK/tas_su_damla.png',
    cinema: '06_GRAFIK/ruh_4lu_sinematik.png',
  ...
  mand: {
    ...
    kolye: '06_GRAFIK/kolye_muhur_resmi.png',
    tile: '06_GRAFIK/tas_toprak_core.png',
    cinema: '06_GRAFIK/ruh_4lu_sinematik.png',
...
class StonebreakingGame {
  constructor(canvas) {
    ...
    this.particles = []; this.selectedTile = null; this.tray = []; this._failed = false; this.locked = false; this.flights = [];
    this.tileImages = {};
    this.sceneImg = null;
    this.sceneKey = '';
    this.ready = false;
    ...
    this.elementSets = {
      ates: [
        ...
        { key: 'ates_1',    color: '#ff6b35', emoji: '🌋', spirit: 'kor', img: '06_GRAFIK/tas_sembol_ates_1.png', mark: 'I' },
        { key: 'ates_2',    color: '#ff8c1a', emoji: '☄️', spirit: 'kor', img: '06_GRAFIK/tas_sembol_ates_8.png', mark: 'II' },
        { key: 'ates_3',    color: '#ff5722', emoji: '💥', spirit: 'kor', img: '06_GRAFIK/tas_sembol_ates_v2.png', mark: 'III' },
        { key: 'ates_4',    color: '#ff4500', emoji: '🕯️', spirit: 'kor', img: '06_GRAFIK/tas_ates_alev.png', mark: 'IV' },
        { key: 'ates_5',    color: '#ff6347', emoji: '⚡', spirit: 'kor', img: '06_GRAFIK/tas_ates_koz.png', mark: 'V' },
        { key: 'ates_6',    color: '#ff7f50', emoji: '🌟', spirit: 'kor', img: '06_GRAFIK/tas_ates_volkan.png', mark: 'VI' },
        { key: 'ates_7',    color: '#e63946', emoji: '💎', spirit: 'kor', img: '06_GRAFIK/tas_ates_core.png', mark: 'VII' },
        { key: 'ates_8',    color: '#ff1a1a', emoji: '🏮', spirit: 'kor', img: '06_GRAFIK/tas_ates_2.png', mark: 'VIII' },
      ],
      su: [
        { key: 'su_core', color: '#1d8cf8', emoji: '💧', spirit: 'baam', img: '06_GRAFIK/tas_su_damla.png', mark: '◆' },
        { key: 'su_1',    color: '#4ecdc4', emoji: '🌊', spirit: 'baam', img: '06_GRAFIK/tas_su_buz.png', mark: 'I' },
        { key: 'su_2',    color: '#3fd4ff', emoji: '❄️', spirit: 'baam', img: '06_GRAFIK/tas_su_sis.png', mark: 'II' },
        { key: 'su_3',    color: '#1d8cf8', emoji: '🐚', spirit: 'baam', img: '06_GRAFIK/tas_su_2.png', mark: 'III' },
        { key: 'su_4',    color: '#0096c7', emoji: '🐋', spirit: 'baam', img: '06_GRAFIK/tas_su_3.png', mark: 'IV' },
        { key: 'su_5',    color: '#00b4d8', emoji: '🦈', spirit: 'baam', img: '06_GRAFIK/tas_su_4.png', mark: 'V' },
        { key: 'su_6',    color: '#48cae4', emoji: '🫧', spirit: 'baam', img: '06_GRAFIK/tas_su_5.png', mark: 'VI' },
        { key: 'su_7',    color: '#90e0ef', emoji: '🪸', spirit: 'baam', img: '06_GRAFIK/tas_su_6.png', mark: 'VII' },
        { key: 'su_8', color: '#0077b6', emoji: '🧊', spirit: 'baam', img: '06_GRAFIK/tas_sembol_su_v2.png', mark: 'VIII' },
      ],
      toprak: [
        { key: 'toprak_core', color: '#2ecc71', emoji: '🌿', spirit: 'mand', img: '06_GRAFIK/tas_toprak_core.png', mark: '◆' },
        { key: 'toprak_1',    color: '#27ae60', emoji: '🪨', spirit: 'mand', img: '06_GRAFIK/tas_toprak_kristal.png', mark: 'I' },
        { key: 'toprak_2',    color: '#1e8449', emoji: '🌳', spirit: 'mand', img: '06_GRAFIK/tas_sembol_toprak_2.png', mark: 'II' },
        { key: 'toprak_3',    color: '#2ecc71', emoji: '🍄', spirit: 'mand', img: '06_GRAFIK/tas_toprak_kaya.png', mark: 'III' },
        { key: 'toprak_4',    color: '#196f3d', emoji: '💎', spirit: 'mand', img: '06_GRAFIK/tas_toprak_run.png', mark: 'IV' },
        { key: 'toprak_5',    color: '#1e8449', emoji: '🌱', spirit: 'mand', img: '06_GRAFIK/tas_toprak_2.png', mark: 'V' },
        { key: 'toprak_6',    color: '#27ae60', emoji: '🪵', spirit: 'mand', img: '06_GRAFIK/tas_toprak_3.png', mark: 'VI' },
        { key: 'toprak_7',    color: '#58d68d', emoji: '🦎', spirit: 'mand', img: '06_GRAFIK/tas_toprak_4.png', mark: 'VII' },
        { key: 'toprak_8', color: '#1a8f4a', emoji: '🐢', spirit: 'mand', img: '06_GRAFIK/tas_sembol_toprak_v2.png', mark: 'VIII' },
      ],
      hava: [
        { key: 'hava_core', color: '#f0f0f0', emoji: '🌬', spirit: 'zepy', img: '06_GRAFIK/tas_sembol_hava_core.png', mark: '◆' },
        { key: 'hava_1',    color: '#a8d8ea', emoji: '☁️', spirit: 'zepy', img: '06_GRAFIK/tas_sembol_hava_1_new.png', mark: 'I' },
        { key: 'hava_2',    color: '#cfe8f5', emoji: '⚡', spirit: 'zepy', img: '06_GRAFIK/tas_sembol_hava_2.png', mark: 'II' },
        { key: 'hava_3',    color: '#e8f4ff', emoji: '🌪️', spirit: 'zepy', img: '06_GRAFIK/tas_hava_bulut.png', mark: 'III' },
        { key: 'hava_4',    color: '#d6eaf8', emoji: '🦅', spirit: 'zepy', img: '06_GRAFIK/tas_hava_simsek.png', mark: 'IV' },
        { key: 'hava_5',    color: '#aed6f1', emoji: '🪶', spirit: 'zepy', img: '06_GRAFIK/tas_hava_spiral.png', mark: 'V' },
        { key: 'hava_6',    color: '#85c1e9', emoji: '🌀', spirit: 'zepy', img: '06_GRAFIK/tas_hava_2.png', mark: 'VI' },
        { key: 'hava_7',    color: '#5dade2', emoji: '🕊️', spirit: 'zepy', img: '06_GRAFIK/tas_hava_3.png', mark: 'VII' },
        { key: 'hava_8', color: '#7fdbff', emoji: '✨', spirit: 'zepy', img: '06_GRAFIK/tas_sembol_hava_v2.png', mark: 'VIII' },
      ],
    };
  ...
  pickToTray(t) {
    ...
    // v8.13: taşı tepsiye GÖTÜR — uçuş animasyonu başlat
    this.flights.push({ type: t.type, x0: r.x + r.w / 2, y0: r.y + r.h / 2, i: this.tray.length - 1, t0: performance.now(), dur: 300 });
    this.updateFree();
  ...
  // v8.13: tepsi slot merkezi (uçuş hedefi)
  traySlotCenter(i) {
    const W = this.viewW, th = this.trayH, gap = this.slotGap || 6, n = TRAY_MAX;
    ...
    return { x: x0 + i * (slotW + gap) + slotW / 2, y: y0 + slotH / 2 };
  }
  ...
  draw() {
    ...
    // v8.13: TAŞI TEPSİYE GÖTÜRME — uçuş animasyonu
    if (this.flights && this.flights.length) {
      ...
      for (let fi = this.flights.length - 1; fi >= 0; fi--) {
        ...
        const d = this.traySlotCenter(f.i);
        const x = f.x0 + (d.x - f.x0) * e;
        const y = f.y0 + (d.y - f.y0) * e - Math.sin(e * Math.PI) * 24;
        const sc = 1 - 0.5 * e;
        // v8.13.1: efsane mod — altın iz partikülleri
        if (Math.random() < 0.5) this.particles.push({ x, y, vx: (Math.random() - 0.5) * 0.6, vy: 0.4, life: 0.5, size: 2, color: (this.types[f.type] && this.types[f.type].color) || '#ffd194' });
        ctx.save();
        ctx.translate(x, y);
        ctx.scale(sc, sc);
        const img = this.tileImages && this.tileImages[f.type];
        if (img) { ctx.drawImage(img, -18, -18, 36, 36); }
        else {
          ctx.fillStyle = (this.types[f.type] && this.types[f.type].color) || '#ffd194';
          ctx.beginPath(); ctx.roundRect(-14, -14, 28, 28, 6); ctx.fill();
        }
        ctx.restore();
        if (k >= 1) { this.spawnShatter(d.x, d.y, (this.types[f.type] && this.types[f.type].color) || '#ffd194'); this.flights.splice(fi, 1); }
      }
      ctx.globalAlpha = 1;
    }
  ...
  drawTile(t) {
    ...
    // 3D DEPTH — alt gölge (güçlendirilmiş)
    ctx.save();
    ctx.fillStyle = 'rgba(0,0,0,0.6)';
    ctx.beginPath();
    ctx.roundRect(r.x + 3 + ox, r.y + 5, r.w, r.h, 6);
    ctx.fill();
    ctx.restore();
  ...
  drawTileFace(type, x, y, w, h, alpha = 1, dim = false, lift = false, selected = false) {
    ...
    // TAŞ GÖVDESİ — PNG cover modu (tam kaplar, balon hissi YOK)
    const img = this.tileImages[meta.key];
    ctx.beginPath();
    ctx.roundRect(x, y, w, h, radius);
    ctx.clip();
    if (img) {
      // v8.9: COVER modu — PNG taşı tam kaplar, boşluk YOK
    ...
    // 3D KENAR EFEKTI — güçlendirilmiş (gerçek taş derinliği)
    ctx.save();
    ctx.beginPath();
    ctx.roundRect(x, y, w, h, radius);
    ctx.clip();
    // Üst aydınlık (ışık kaynağı yukarıdan)
    const topLight = ctx.createLinearGradient(x, y, x, y + h * 0.3);
    topLight.addColorStop(0, 'rgba(255,255,255,0.28)');
    topLight.addColorStop(1, 'rgba(255,255,255,0)');
    ctx.fillStyle = topLight;
    ctx.fillRect(x, y, w, h * 0.3);
    // Alt gölge (derinlik)
    const bottomShade = ctx.createLinearGradient(x, y + h * 0.65, x, y + h);
    bottomShade.addColorStop(0, 'rgba(0,0,0,0)');
    bottomShade.addColorStop(1, 'rgba(0,0,0,0.45)');
    ctx.fillStyle = bottomShade;
    ctx.fillRect(x, y + h * 0.65, w, h * 0.35);
    // Sol aydınlık
    const leftLight = ctx.createLinearGradient(x, y, x + w * 0.2, y);
    leftLight.addColorStop(0, 'rgba(255,255,255,0.15)');
    leftLight.addColorStop(1, 'rgba(255,255,255,0)');
    ctx.fillStyle = leftLight;
    ctx.fillRect(x, y, w * 0.2, h);
    // Sağ gölge
    const rightShade = ctx.createLinearGradient(x + w * 0.8, y, x + w, y);
    ...
    // v7.11: BÜYÜK EMOJİ — PNG olsa bile her zaman çiz (ayırt edicilik)
    ...
    // Rim light (güçlendirilmiş — taş çerçevesi)
    ctx.strokeStyle = selected
      ? meta.color
      : (dim ? 'rgba(220,210,190,0.15)' : 'rgba(255,236,200,0.50)');
    ctx.lineWidth = selected ? 3 : 2;
    ctx.beginPath();
    ctx.roundRect(x + 0.5, y + 0.5, w - 1, h - 1, radius);
    ctx.stroke();

    // 3D ALT KALINLIK (güçlendirilmiş — gerçek taş derinliği)
    const baseH = Math.max(6, h * 0.12);
    const baseGrad = ctx.createLinearGradient(x, y + h - baseH, x, y + h);
    baseGrad.addColorStop(0, 'rgba(0,0,0,0.35)');
    baseGrad.addColorStop(0.5, 'rgba(0,0,0,0.55)');
    baseGrad.addColorStop(1, 'rgba(0,0,0,0.7)');
    ctx.fillStyle = baseGrad;
    ctx.beginPath();
    ctx.roundRect(x + 1, y + h - baseH, w - 2, baseH, 2);
    ctx.fill();
