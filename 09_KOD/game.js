  ...
  constructor(canvas) {
    ...
    this.elementSets = {
      ates: [
        ...
        { key: 'ates_2',    color: '#ff8c1a', emoji: '🔥', spirit: 'kor', img: '06_GRAFIK/tas_sembol_ates_8.png', mark: '' },
        { key: 'ates_3',    color: '#ff5722', emoji: '🔥', spirit: 'kor', img: '06_GRAFIK/tas_sembol_ates_v2.png', mark: '' },
        { key: 'ates_4',    color: '#ff4500', emoji: '🔥', spirit: 'kor', img: '06_GRAFIK/tas_ates_alev.png', mark: '' },
        { key: 'ates_5',    color: '#ff6347', emoji: '🔥', spirit: 'kor', img: '06_GRAFIK/tas_ates_koz.png', mark: '' },
        { key: 'ates_6',    color: '#ff7f50', emoji: '🔥', spirit: 'kor', img: '06_GRAFIK/tas_ates_volkan.png', mark: '' },
        { key: 'ates_7',    color: '#e63946', emoji: '🔥', spirit: 'kor', img: '06_GRAFIK/tas_ates_core.png', mark: '' },
        { key: 'ates_8',    color: '#ff1a1a', emoji: '🔥', spirit: 'kor', img: '06_GRAFIK/tas_ates_2.png', mark: '' },
      ],
      su: [
        { key: 'su_core', color: '#1d8cf8', emoji: '💧', spirit: 'baam', img: '06_GRAFIK/tas_su_damla.png', mark: '' },
        { key: 'su_1',    color: '#4ecdc4', emoji: '💧', spirit: 'baam', img: '06_GRAFIK/tas_su_buz.png', mark: '' },
        { key: 'su_2',    color: '#3fd4ff', emoji: '💧', spirit: 'baam', img: '06_GRAFIK/tas_su_sis.png', mark: '' },
        { key: 'su_3',    color: '#1d8cf8', emoji: '💧', spirit: 'baam', img: '06_GRAFIK/tas_su_2.png', mark: '' },
        { key: 'su_4',    color: '#0096c7', emoji: '💧', spirit: 'baam', img: '06_GRAFIK/tas_su_3.png', mark: 'I' },
        { key: 'su_5',    color: '#00b4d8', emoji: '💧', spirit: 'baam', img: '06_GRAFIK/tas_su_4.png', mark: 'II' },
        { key: 'su_6',    color: '#48cae4', emoji: '💧', spirit: 'baam', img: '06_GRAFIK/tas_su_5.png', mark: 'III' },
        { key: 'su_7',    color: '#90e0ef', emoji: '💧', spirit: 'baam', img: '06_GRAFIK/tas_su_6.png', mark: 'IV' },
      ...
      toprak: [
        ...
        { key: 'toprak_1',    color: '#27ae60', emoji: '🌿', spirit: 'mand', img: '06_GRAFIK/tas_toprak_kristal.png', mark: '' },
        { key: 'toprak_2',    color: '#1e8449', emoji: '🌿', spirit: 'mand', img: '06_GRAFIK/tas_sembol_toprak_2.png', mark: '' },
        { key: 'toprak_3',    color: '#2ecc71', emoji: '🌿', spirit: 'mand', img: '06_GRAFIK/tas_toprak_kaya.png', mark: '' },
        { key: 'toprak_4',    color: '#196f3d', emoji: '🌿', spirit: 'mand', img: '06_GRAFIK/tas_toprak_run.png', mark: 'I' },
        { key: 'toprak_5',    color: '#1e8449', emoji: '🌿', spirit: 'mand', img: '06_GRAFIK/tas_toprak_2.png', mark: 'II' },
        { key: 'toprak_6',    color: '#27ae60', emoji: '🌿', spirit: 'mand', img: '06_GRAFIK/tas_toprak_3.png', mark: 'III' },
        { key: 'toprak_7',    color: '#58d68d', emoji: '🌿', spirit: 'mand', img: '06_GRAFIK/tas_toprak_4.png', mark: 'IV' },
      ...
      hava: [
        ...
        { key: 'hava_1',    color: '#a8d8ea', emoji: '🌬', spirit: 'zepy', img: '06_GRAFIK/tas_sembol_hava_1_new.png', mark: '' },
        { key: 'hava_2',    color: '#cfe8f5', emoji: '🌬', spirit: 'zepy', img: '06_GRAFIK/tas_sembol_hava_2.png', mark: '' },
        { key: 'hava_3',    color: '#e8f4ff', emoji: '🌬', spirit: 'zepy', img: '06_GRAFIK/tas_hava_bulut.png', mark: '' },
        { key: 'hava_4',    color: '#d6eaf8', emoji: '🌬', spirit: 'zepy', img: '06_GRAFIK/tas_hava_simsek.png', mark: 'I' },
        { key: 'hava_5',    color: '#aed6f1', emoji: '🌬', spirit: 'zepy', img: '06_GRAFIK/tas_hava_spiral.png', mark: 'II' },
        { key: 'hava_6',    color: '#85c1e9', emoji: '🌬', spirit: 'zepy', img: '06_GRAFIK/tas_hava_2.png', mark: 'III' },
        { key: 'hava_7',    color: '#5dade2', emoji: '🌬', spirit: 'zepy', img: '06_GRAFIK/tas_hava_3.png', mark: 'IV' },
